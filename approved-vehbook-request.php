...
<html lang="en">
  <head>
    ...
    <title>Employee Transport System|| Approved Vehicle Booking Request</title>
    <meta charset="utf-8">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
               <h2 align="center"> Approved Vehicle Booking Requests</h2>
              <hr />
...
join tblemployee on tblemployee.EmpID=tblvehbook.EmpID join tblvehicle on tblvehicle.ID=tblvehbook.VehID where tblvehbook.AdminStatus='Approved'";
