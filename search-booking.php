   ...
   <?php include 'include/header.php'; ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
          ...
          <!---Error Message--->
                      <h3 class="tile-title">Search Booking</h3>
            <div class="tile-body">
              <form class="row" method="post">
               <div class="form-group col-md-6">
                  <label class="control-label">Search By Booking Number/ Emp Name / Emp ID/</label>
...
where tblvehbook.BookingID like '$searchinput' || tblemployee.EmpId like '$searchinput' || tblemployee.EmpId like '$fname'";
