...
<html lang="en">
  <head>
    ...
    <title>Employee Transport System || Manage Employee</title>
    <meta charset="utf-8">
...
left join tbldepartment on tblemployee.department_name=tbldepartment.id";
    ...
    <a href="manage-employee.php?del=<?php echo htmlentities($result->id);?>"><span class="btn btn-danger">Delete</span>
