   ...
   <?php include 'include/header.php'; ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
          ...
          <!---Error Message--->
                      <h3 class="tile-title">Search Employee</h3>
            <div class="tile-body">
              <form class="row" method="post">
               <div class="form-group col-md-6">
                  <label class="control-label">Search By Name, EmpID, Mobile Number</label>
...
where EmpId like '$searchinput' || mobile like '$searchinput' || fname like '$searchinput' || lname like '$searchinput'";
